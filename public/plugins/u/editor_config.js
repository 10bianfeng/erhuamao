...
(function () {
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,toolbars:[["paragraph","forecolor","backcolor","bold","italic","underline","undo","redo","insertunorderedlist","insertorderedlist","justifyleft","justifycenter","justifyright","justifyjustify","horizontal","separate","inserttable","deletetable","insertvideo","link","unlink","gmap","map","blockquote","preview","fullscreen"],[],[]]
